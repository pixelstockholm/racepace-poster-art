...
export const RACE_IDENTITIES: Record<string, RaceIdentity> = {
  berlin:     { paper: "#E9E2D0", ink: "#0E1A12", accent: "#6B6A64", support: "#1F3A2E", mark: "#0E1A12", tagline: "Tiergarten · Mitte · Brandenburger Tor" },
  nyc:        { paper: "#0B1B2B", ink: "#F2EDE1", accent: "#13294B", support: "#3A6EA5", mark: "#F2EDE1", tagline: "Five boroughs · Verrazzano to Central Park" },
  london:     { paper: "#0A2540", ink: "#F2EDE1", accent: "#7A1E2D", support: "#9C2A2A", mark: "#F2EDE1", tagline: "Greenwich to The Mall" },
  boston:     { paper: "#EFE7D6", ink: "#0C1F3A", accent: "#2E5E3E", support: "#0C1F3A", mark: "#2E5E3E", tagline: "Hopkinton to Boylston Street" },
  chicago:    { paper: "#E5DCC6", ink: "#0F1B2D", accent: "#C0392B", support: "#5B8DB7", mark: "#0F1B2D", tagline: "Grant Park · The Loop" },
  tokyo:      { paper: "#F2EDE1", ink: "#0B0B0C", accent: "#E94B35", support: "#1F2937", mark: "#E94B35", tagline: "Shinjuku to Tokyo Station" },
  paris:      { paper: "#0E2A47", ink: "#F4EBD8", accent: "#1D2A44", support: "#C9A227", mark: "#F4EBD8", tagline: "Champs-Élysées · Bois de Vincennes" },
  stockholm:  { paper: "#E8E3D5", ink: "#0B1F3A", accent: "#D6BF68", support: "#0B5394", mark: "#0B1F3A", tagline: "Bridges across the archipelago" },
  valencia:   { paper: "#F2E6CF", ink: "#1A1A1A", accent: "#C4633A", support: "#1F6F8B", mark: "#1A1A1A", tagline: "Ciudad de las Artes y las Ciencias" },
  amsterdam:  { paper: "#EFE6D2", ink: "#0E1A12", accent: "#7A1E2D", support: "#2E5E3E", mark: "#0E1A12", tagline: "Olympisch Stadion · Amstel · canal ring" },
