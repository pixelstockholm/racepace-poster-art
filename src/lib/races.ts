...
export const RACES: Race[] = [
  ...
  {
    id: "munich",
    name: "Generali München Marathon",
    city: "Munich",
    country: "Germany",
    date: "2024-10-13",
    distanceKm: 42.195,
...
export function raceEditionTitle(race: Race): string {
  return `${race.city} Edition`;
}

export function raceEditionSubtitle(race: Race): string {
  return race.name;
}
